...
export default function GrowthAnalyticsPage() {
  ...
  if (error) return <div className="text-red-300">Failed to load growth analytics</div>;
  const events = data?.events ?? [];
  return (
    <div className="space-y-4">
      <div>
        <div className="text-sm text-slate-400">Funnels, referrals, and activation metrics.</div>
        <div className="text-2xl font-semibold">Growth Analytics</div>
      </div>
